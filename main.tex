...
A mass grow out and genotyping of all inbred lines in the total pedigree would be ideal, realistically, we do not have the resources (either in terms of time, space, or available germplasm) to do this.
