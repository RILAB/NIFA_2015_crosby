...
In the case of maize, we have contemporary lines from various mapping populations, their genotypes, and their phenotypes, e. the Nested Association Mapping population (NAM) \CITE{} is one such example.   
