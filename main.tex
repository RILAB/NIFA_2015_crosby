...
%rjw: This last statement still does not rest well with me. The study classified alleles as "favorable" based on enriched in more modern germplasm then asked which of those alleles were present across the genome of lines (not alleles) that were "underutilized." The alleles themselves were identified because they were utilized. My suggestion is to remove the word underutilized here and say enriched with adaptive alleles. This then opens the debatable point about whether it is valuable to mine for diversity in old underutilized lines at the loci where favorable alleles have been declared. I believe this point needs to be more clearly addressed below, and I also think that J Holland's framing for this is best -- basically, losses due to drift.

My suggestion is to remove the word underutilized here and say enriched with adaptive alleles. 

This then opens the debatable point about whether it is valuable to mine for diversity in old underutilized lines at the loci where favorable alleles have been declared. I believe this point needs to be more clearly addressed below, and I also think that J Holland's framing for this is best -- basically, losses due to drift.
...
Instead, historical pedigree information existis primarily in the minutes of breeding committees, old breeding program books, and other hard-copy sources with limited distribution.  
...
%\kc{Below for how typical inbred lines are produced - but ditch huge figure and make a cartoon - easier to understand.
%Using Mendelian rules and starting with homozygous parents for opposite allelic combinations at a single locus (i.e. $AA$ for parent 1 and $aa$ for parent2) we know that our expectations ($E$) for number ($N$) of $AA$ (or $aa$) homozygous inbred progeny at generation 6 (under no selection) should be given by $E = 1/2 N$. If our observations deviate from this expectation, we would tend to conclude selection.} 
