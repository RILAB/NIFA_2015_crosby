...
In the case of maize, we have contemporary lines from various mapping populations, their genotypes, and their phenotypes, e.g. the Nested Association Mapping population (NAM) \textcolor{red}{CITE NAM ori}   
