...
%\jri{year 3 plot we grow up 50 bad lines, 50 good lines (steal the design from my email, 2 rows of 10 each, phenotype middle 5, what traits, etc. to compare predicted "good" lines and predicted "bad" lines.  We also include as check some set of ex-PVP -- see my email to Randy for details}
