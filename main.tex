...
Ideally, field-testing of these lines would be more comprehensive, including more replication, better controls, and multiple environments. However, we are working under space/time constraints and more importantly with limited germplasm obtained from seed repositories.
