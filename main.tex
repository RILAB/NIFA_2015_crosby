...
Parentage alone is sufficient for allele-dropping and prediction (see Aim 2), but not knowing the number of meioses makes it difficult to know the uncertainty associated with prediction or use pedigree data to understand recombination. \textcolor{violet}{However, with genomic data we will attempt to correct some incomplete pedigrees.}
...
% * <rjw@udel.edu> 2015-04-05T11:35:32.794Z:
%
...
The middle 5 plants of each plot will be phenotyped for the trait of interest as well as a set of phenotypes of general agronomic interest to evaluate lines per se (standability, flowering time, plant height, ear height, leaf angle, 50k weight, and yield) and provide some data for reverse-validation (from phenotype to genotype) or to serve as negative controls for the approach.
...
% * <rjw@udel.edu> 2015-04-05T11:44:17.928Z:
%
%  Ideally we would do a seed increase in the same environment of all the lines to be tested. Here we are taking seed from various sources (increased at different times in different environments) and trying to comparatively evaluate. Maybe acknowledge the issue that seed sources are likely to be different and may cause differences in germination and other traits and we will standardize temporal trait data on germination date. Or else just don't bring up the issue. Your call.
%
...
% * <rjw@udel.edu> 2015-04-05T11:13:33.878Z:
%
%  Is this a new requirement or something? If not, delete this whole section. The field bit actually sounds strange b/c these are standard conditions for field of work and there is no need to detail things here. This is like saying that for laboratory work people be provided with personal protective equipment including a lab coat, latex or nitrite gloves and safety glasses, they will be required to wear closed toe shoes ... on and on you get the point. This whole section on hazards could be removed or for the field bit re-write like you have for lab training to say students will be trained and advised on field safety...
%
