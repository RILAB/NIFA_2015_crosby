...
We will first test this approach in two breeding programs in which we know the selection applied by breeders and we have empirical data on the response. Currently, these breeding programs are: ear number in Golden Glow \citep{beissinger2014genome} and flowering-time in a tropical-temperate population \citep{Teixeira:2014hr}.
...
\textcolor{violet}{We bring it up with the ``Assuming statement above'', so I do think we need to acknowledge the possibility that we may not be able to isolate this signal - do we need to say something positive here - one sentence...}
Finally, with the second approach, we acknowledge that we may not find evidence of a diffuse signal of selection in the two example breeding programs mentioned in the section above \citep{beissinger2014genome,Teixeira:2014hr}.      
